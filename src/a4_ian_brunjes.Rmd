...
TODO: A 4 - 5 sentence "mini-introduction" to what this study is exploring, including basic background information about the subject, site and study (with citations as needed), and a brief overview of what is included in the exploratory report. You should probably do this last.
...
```{r include=FALSE}
# Find min/max and mean/median values of annual hare counts
...
# Check assumptions of normality via hist & qq
...
mean_diff_pct <- (male_mean-female_mean)/female_mean * 100
...
TODO: Include a very short summary describing your main findings from your juvenile hares exploration (bulletpoints are fine)
